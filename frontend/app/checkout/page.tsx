...
import { trackInitiateCheckoutWhenReady, trackPurchaseWhenReady, trackGerouPixWhenReady } from "@/lib/checkoutTracking";
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("clipsaas_checkout_data");
      if (saved) {
        try {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const data = { name, email, whatsapp, cpf };
      localStorage.setItem("clipsaas_checkout_data", JSON.stringify(data));
    }
  ...
  const handleGeneratePIX = async () => {
    ...
    try {
      ...
      trackGerouPixWhenReady(data.correlationID, totalCents);
      startTimer();
                    ...
                    <div style={{
                      ...
                      <div style={{ 
                        ...
                        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                          ...
                          <span><strong>Instagram:</strong> @danielpaixaog</span>
                        </div>
                        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
